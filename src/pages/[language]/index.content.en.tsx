...
const HomePageContentEnglish = function HomePageContentEnglish() {
  return (
    <Grid>
      ...
      <Grid.Column mobile={16} tablet={16} computer={7}>
        ...
        <Segment>
          <Label ribbon="right" className={styles["label-right"]}>
            <FontAwesomeIcon icon={faUserGraduate} /> Soft and Seniorship Skills
          </Label>
          <Container className={styles.boxed}>
...
export { HomePageContentEnglish, HomePageContentEnglish as default };
