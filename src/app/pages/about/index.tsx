...
Evliliğim ve İzmir'e taşınmamla birlikte, Yazılım Geliştirme Lideri olarak KoçSistem'e katılarak görevlendirildiğim projelerde hizmet ve teslimat sürekliliğini sağladım. Yine KoçSistem içerisinde Ar-Ge ve İş Uygulamaları altında Kurumsal Mimari ekibinde görev aldım.
...
- Özellikle Cloud ve DevOps konularında konuşmalar hazırlayıp konferanslarda ve diğer etkinliklerde konuşmalar yaparak deneyimlerimi yaymaya çalışıyorum.
- Meetup ve komuniteye ait etkinliklere yıllardır aktif katılım yapıp, jstanbul ve devizmir gibi komunitelerin organizasyonunda olduğumdan yazılım profesyonellerinden oluşan geniş bir çevrem olduğunu düşünüyorum.
...
- Populer çizgi roman külliyatına derinlemesine bir hakimiyetim vardır.
...
- Bir ara ciddi bir bisiklet kullanıcısıydım, Semi-Pro seviye Trek 4500 bir bisikletim vardı. Kıbrıs'tan buraya lojistiğini sağlayamadığım için konuyu geride bıraktım.
